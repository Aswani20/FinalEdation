...
public class DrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_note) {
            Intent intent=new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.rapidtables.com/tools/notepad.html"));
            startActivity(intent);
        } else if (id == R.id.nav_guide) {
            Intent intent= new Intent(this, studentGuide.class);
            startActivity(intent);

        } else if (id == R.id.nav_connect) {
            Intent intent= new Intent(this, connectUs.class);
            startActivity(intent);
    ...
    public void openqrattendence(){
        Intent intent = new Intent(this, qrattendance.class);
        startActivity(intent);
    }
